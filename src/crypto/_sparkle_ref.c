...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit__sparkle_ref(const void *p[])
{
...
#  ifdef _MSC_VER
     PyMODINIT_FUNC
#  if PY_MAJOR_VERSION >= 3
     PyInit__sparkle_ref(void) { return NULL; }
#  else
     init_sparkle_ref(void) { }
#  endif
#  endif
#elif PY_MAJOR_VERSION >= 3
PyMODINIT_FUNC
PyInit__sparkle_ref(void)
{
  return _cffi_init("_sparkle_ref", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
init_sparkle_ref(void)
{
  _cffi_init("_sparkle_ref", 0x2601, &_cffi_type_context);
}
#endif
