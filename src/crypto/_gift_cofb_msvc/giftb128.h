/*
 * MSVC-compatible version of giftb128.h from GIFT-COFB opt32.
 * Replaces GCC statement expression ({ ... }) in QUINTUPLE_ROUND with
 * do { ... } while(0). Algorithm logic is identical.
 *
 * Original: gift-cofb/crypto_aead/giftcofb128v1/opt32/giftb128.h
 */
#ifndef GIFT128_H_
#define GIFT128_H_
