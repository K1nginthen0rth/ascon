...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit__grain_ref(const void *p[])
{
...
#  ifdef _MSC_VER
     PyMODINIT_FUNC
#  if PY_MAJOR_VERSION >= 3
     PyInit__grain_ref(void) { return NULL; }
#  else
     init_grain_ref(void) { }
#  endif
#  endif
...
PyMODINIT_FUNC
PyInit__grain_ref(void)
{
  return _cffi_init("_grain_ref", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
init_grain_ref(void)
{
  _cffi_init("_grain_ref", 0x2601, &_cffi_type_context);
}
#endif
