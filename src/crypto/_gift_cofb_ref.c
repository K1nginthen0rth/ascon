...
/*  0 */ _CFFI_OP(_CFFI_OP_FUNCTION, 22), // int()(unsigned char *, unsigned long long *, unsigned char *, unsigned char const *, unsigned long long, unsigned char const *, unsigned long long, unsigned char const *, unsigned char const *)
/*  1 */ _CFFI_OP(_CFFI_OP_POINTER, 23), // unsigned char *
/*  2 */ _CFFI_OP(_CFFI_OP_POINTER, 5), // unsigned long long *
/*  3 */ _CFFI_OP(_CFFI_OP_NOOP, 1),
/*  4 */ _CFFI_OP(_CFFI_OP_POINTER, 23), // unsigned char const *
...
/* 11 */ _CFFI_OP(_CFFI_OP_FUNCTION, 22), // int()(unsigned char *, unsigned long long *, unsigned char const *, unsigned long long, unsigned char const *, unsigned long long, unsigned char const *, unsigned char const *, unsigned char const *)
/* 12 */ _CFFI_OP(_CFFI_OP_NOOP, 1),
/* 13 */ _CFFI_OP(_CFFI_OP_NOOP, 2),
/* 14 */ _CFFI_OP(_CFFI_OP_NOOP, 4),
/* 15 */ _CFFI_OP(_CFFI_OP_PRIMITIVE, 12),
/* 16 */ _CFFI_OP(_CFFI_OP_NOOP, 4),
/* 17 */ _CFFI_OP(_CFFI_OP_PRIMITIVE, 12),
...
/* 23 */ _CFFI_OP(_CFFI_OP_PRIMITIVE, 4), // unsigned char
};

static int _cffi_d_crypto_aead_decrypt(unsigned char * x0, unsigned long long * x1, unsigned char * x2, unsigned char const * x3, unsigned long long x4, unsigned char const * x5, unsigned long long x6, unsigned char const * x7, unsigned char const * x8)
{
  return crypto_aead_decrypt(x0, x1, x2, x3, x4, x5, x6, x7, x8);
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_crypto_aead_decrypt(PyObject *self, PyObject *args)
{
  unsigned char * x0;
  ...
  if (!PyArg_UnpackTuple(args, "crypto_aead_decrypt", 9, 9, &arg0, &arg1, &arg2, &arg3, &arg4, &arg5, &arg6, &arg7, &arg8))
    return NULL;
  ...
  _cffi_restore_errno();
  { result = crypto_aead_decrypt(x0, x1, x2, x3, x4, x5, x6, x7, x8); }
  _cffi_save_errno();
...
#else
#  define _cffi_f_crypto_aead_decrypt _cffi_d_crypto_aead_decrypt
#endif

static int _cffi_d_crypto_aead_encrypt(unsigned char * x0, unsigned long long * x1, unsigned char const * x2, unsigned long long x3, unsigned char const * x4, unsigned long long x5, unsigned char const * x6, unsigned char const * x7, unsigned char const * x8)
{
  return crypto_aead_encrypt(x0, x1, x2, x3, x4, x5, x6, x7, x8);
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_crypto_aead_encrypt(PyObject *self, PyObject *args)
{
  unsigned char * x0;
  unsigned long long * x1;
  ...
  if (!PyArg_UnpackTuple(args, "crypto_aead_encrypt", 9, 9, &arg0, &arg1, &arg2, &arg3, &arg4, &arg5, &arg6, &arg7, &arg8))
    return NULL;
  ...
  Py_BEGIN_ALLOW_THREADS
  _cffi_restore_errno();
  { result = crypto_aead_encrypt(x0, x1, x2, x3, x4, x5, x6, x7, x8); }
  _cffi_save_errno();
  Py_END_ALLOW_THREADS
...
#else
#  define _cffi_f_crypto_aead_encrypt _cffi_d_crypto_aead_encrypt
#endif

static const struct _cffi_global_s _cffi_globals[] = {
  { "crypto_aead_decrypt", (void *)_cffi_f_crypto_aead_decrypt, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_V, 0), (void *)_cffi_d_crypto_aead_decrypt },
  { "crypto_aead_encrypt", (void *)_cffi_f_crypto_aead_encrypt, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_V, 11), (void *)_cffi_d_crypto_aead_encrypt },
};
...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit__gift_cofb_ref(const void *p[])
{
...
#  ifdef _MSC_VER
     PyMODINIT_FUNC
#  if PY_MAJOR_VERSION >= 3
     PyInit__gift_cofb_ref(void) { return NULL; }
#  else
     init_gift_cofb_ref(void) { }
#  endif
#  endif
#elif PY_MAJOR_VERSION >= 3
PyMODINIT_FUNC
PyInit__gift_cofb_ref(void)
{
  return _cffi_init("_gift_cofb_ref", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
init_gift_cofb_ref(void)
{
  _cffi_init("_gift_cofb_ref", 0x2601, &_cffi_type_context);
}
#endif
