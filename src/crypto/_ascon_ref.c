...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit__ascon_ref(const void *p[])
{
...
#  ifdef _MSC_VER
     PyMODINIT_FUNC
#  if PY_MAJOR_VERSION >= 3
     PyInit__ascon_ref(void) { return NULL; }
#  else
     init_ascon_ref(void) { }
#  endif
#  endif
...
PyMODINIT_FUNC
PyInit__ascon_ref(void)
{
  return _cffi_init("_ascon_ref", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
init_ascon_ref(void)
{
  _cffi_init("_ascon_ref", 0x2601, &_cffi_type_context);
}
#endif
