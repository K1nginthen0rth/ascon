"""
Wrapper Python para GIFT-COFB (opt32, NIST LWC Round 3 finalist) via cffi.
...
class GiftCOFB:
    """
    Wrapper Python para GIFT-COFB (opt32, NIST LWC Round 3 finalist).
    ...
    def metadata(self) -> dict[str, object]:
        ...
        return {
            "algo": "GIFT-COFB",
            "standard": "NIST LWC Round 3 finalist",
